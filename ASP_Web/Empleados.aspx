...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:TextBox ID="txt_fecha" runat="server" CssClass="form-control" placeholder="Fecha yyyy-mm-dd" TextMode="Date"></asp:TextBox>
    ...
    <asp:Label ID="lbl_mensaje" runat="server" CssClass="badge" Font-Size="Medium"></asp:Label>
